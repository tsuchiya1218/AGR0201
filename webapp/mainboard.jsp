		...
		<table border=0 cellpadding=0 cellspacing=0 width=878 height=100%>
			<tr>
				...
				<td width=678 valign=top bgcolor=#FFFFFF
					...
					<form action="./mainboard_check.jsp" method="post" style="margin: 0;">
						...
						<table border=0 cellpadding=0 cellspacing=0 width=100% class="th">
							...
							<tr>
								<td colspan=5 align="center">
									<h4 class="subTitle">MainBoardの仕様詳細入力</h4>
									...
									<table border=0 cellpadding=2 cellspacing=1 bgcolor="#DADADA"
										...
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="FormFactor" id="sellprice" value="" size=25
										...
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Socket" id="sellprice" value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="MemorySlot" id="sellprice" value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Chipset" id="sellprice" value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="m.2" id="sellprice" value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="sata3.0" id="sellprice" value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="pcieSlot" id="sellprice" value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="USBPort" id="sellprice" value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Audio" id="sellprice" value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										...
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="OS" id="sellprice" value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
