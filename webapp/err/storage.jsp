							...
							<table border=0 cellpadding=0 cellspacing=0 width=100% class="th">
								...
								<tr>
									<td colspan=5 align="center">
										<h4 class="subTitle">ストレージの仕様詳細入力</h4>
										...
										<table border=0 cellpadding=2 cellspacing=1 bgcolor="#DADADA"
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>パッケージ数量</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>フォームファクタ</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>デバイスタイプ</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
