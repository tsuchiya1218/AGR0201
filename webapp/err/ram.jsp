										...
										<table border=0 cellpadding=2 cellspacing=1 bgcolor="#DADADA"
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>メモリータイプ</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>メモリモジュール機能</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
