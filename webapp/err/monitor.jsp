			...
			<table border=0 cellpadding=0 cellspacing=0 width=878 height=100%>
				<tr>
					...
					<td width=678 valign=top bgcolor=#FFFFFF
						...
						<form name=form1
							action="/makeshop/newmanager/product_registry.html" method=post
							...
							<table border=0 cellpadding=0 cellspacing=0 width=100% class="th">
								...
								<tr>
									<td colspan=5 align="center">
										<h4 class="subTitle">モニターの仕様詳細入力</h4>
										...
										<table border=0 cellpadding=2 cellspacing=1 bgcolor="#DADADA"
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>アダプティプシンク技術</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
											...
											<tr bgcolor="#FFFFFF">
												...
												<td colspan="3">
													<p>
														<input name=sellprice id="sellprice" value="" size=25
															maxlength="9" style="ime-mode: disabled;"> cd/m2
													</p>
												</td>
											</tr>
											<tr bgcolor="#FFFFFF">
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>スクリーソコーティング</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>カーブスクリーソ</font>&nbsp;
														</div>
													</div>
												</th>
											...
											<tr bgcolor="#FFFFFF">
												...
												<td colspan="3">
													<p>
														<input name=sellprice id="sellprice" value="" size=25
															maxlength="9" style="ime-mode: disabled;"> mm
													</p>
												</td>
											</tr>
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>コントラスト比</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>ディスプレイ位置調整</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
											...
											<tr bgcolor="#FFFFFF">
												...
												<td colspan="3">
													<p>
														<input name=sellprice id="sellprice" value="" size=25
															maxlength="9" style="ime-mode: disabled;"><br>
													<p class="formAssist">
														奥＊幅行き＊高さ<br>
													</p>
													</p>
