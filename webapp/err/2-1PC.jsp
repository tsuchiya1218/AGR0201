										...
										<table border=0 cellpadding=2 cellspacing=1 bgcolor="#DADADA"
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>ハードドライバ</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>ネットワークアダプター</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
											...
											<tr bgcolor="#FFFFFF">
												<th bgcolor="#F0F0F0" align="right" height="30">
													<div class="beginnerWrap">
														<div class="beginner">
															<font color=#3D3D3D>プライマリバッテリー</font>&nbsp;
														</div>
													</div>
												</th>
												<td colspan="3">
