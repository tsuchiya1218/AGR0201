						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%"
							...
							<tr>
								<td colspan="5" align="center">
									...
									<h5 class="largeTxt">商品の仕様詳細情報を入力してください。</h5> <!-- 商品情報入力フォーム -->
									<table border="0" cellpadding="2" cellspacing="1"
										...
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="CPUClock" id="sellprice" required value=""
										...
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Wireless_LAN" id="sellprice" required value=""
														size=25 maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="LAN_Cable" id="sellprice" required value=""
														size=25 maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
