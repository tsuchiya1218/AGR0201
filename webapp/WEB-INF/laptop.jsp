		...
		<table border=0 cellpadding=0 cellspacing=0 width=878 height=100%>
			<tr>
				...
				<td width="678" valign="top" bgcolor="#FFFFFF"
					...
					<form action="./desktop_check.jsp" method="post" style="margin: 0;">
						<table border="0" cellpadding="0" cellspacing="0" width="100%" class="th">
							...
							<tr>
								<td colspan="5" align="center">
									...
									<h5 class="largeTxt">商品の仕様詳細情報を入力してください。</h5> 
									
									<!-- 商品情報入力フォーム -->
									<table border="0" cellpadding="2" cellspacing="1" bgcolor="#DADADA"	width="100%" class="productInfoInput">
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<!-- 
													<input name="OS" id="sellprice" required value="" size=25
										...
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="CPUClock" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Memory" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Storage" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="GraphicCard" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="DisplayPort" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Wireless_LAN" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="LAN_Cable" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										...
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Bluetooth" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="USBPort" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Weight" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Width" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Height" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											...
											<td colspan="3">
												<p>
													<input name="Depth" id="sellprice" required value="" size=25
														maxlength="9" style="ime-mode: disabled;">
												</p>
											</td>
										</tr>
